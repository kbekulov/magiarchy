...
assert.ok(read('persistent-music.js').includes('audio.loop = true'), 'Music: persistent player must repeat');
assert.ok(read('script.js').includes("import('./persistent-music.js')"), 'Music: shared player missing');
