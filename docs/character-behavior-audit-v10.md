...
The [church interlude](../moments.html?moment=only-eyes-for-you) now follows the author's recurring setup: Lynleit and Fionn visit churches with Felix and Reiner. Reiner behaves; Felix keeps flirting with the nuns until Lynleit loses patience. Current F, M, and S notes address that accumulated irritation, his instinctive flattering reply, and the straight-person roles of Reiner and the nun. They do not encourage a jealous reading or make Fionn an unrequested commentator. V1 retains its earlier draft and version-scoped notes; v2 supplies the shared scene. Exact placement before Fionn's death and the purpose of the visits remain open.
