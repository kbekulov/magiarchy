...
Read [Dread and Action Direction](../docs.html?doc=dread-and-action-direction) for MAGIARCHY's principles of isolation, danger, pressured action, and relief. For a relevant draft, ask:
