const profileSeeds = [
  ...
  },
  {
    ...
    connections: [
      { name: 'Lynleit', relation: 'Cardiff counterpart and difficult penitent', detail: 'Lynleit reaches Mikhail after his foreign assignment becomes a life-and-death operation. They protect one another despite lasting moral incompatibility. He later confirms that the curse she shares with Kyrien can be broken through identity transformation and invokes her lineage\'s Cult of Inanna association in a mock blessing before giving the practical answer with a bluntness that leaves her furious.' }
    ],
