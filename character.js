const profileSeeds = [
  ...
  },
  {
    ...
    personalitySummary: 'Kyrien speaks little and smiles less, but the reserve conceals an intensely competitive streak. Cards, chess, an investigation, and a gunfight can all become contests he feels compelled to win. He accepts hard play, but reacts quickly when an opponent cheats, and that urge to punish unfairness can pull him away from the safer objective. His restraint is therefore learned discipline rather than emotional emptiness.',
    traits: [
    ...
    tradecraft: [
      ...
      { label: 'Reciprocal force', title: 'Firearms', detail: 'His father taught him that pointing a weapon creates an obligation, not authority. Kyrien keeps the lesson as a personal rule: "You cannot do much in this world without life or death stakes. But if you dare to point a gun at someone, you should be prepared to be shot yourself." Firearms remain precise operational tools for creating distance, interruption, or an escape window, never proof that he is untouchable.' },
    ...
    connections: [
      { name: 'Lynleit', relation: 'Handler and eventual partner', detail: 'She begins as his handler rather than a willing partner. After he alone witnesses her walking on water, he denies seeing anything and keeps the forbidden secret. Drenched and breathless, they sit back to back for warmth, creating the first trigger in a bond that grows through functional care rather than overt romance. The hotel-room refuge follows much later after Fionn\'s murder, and they do not have sex until the end of the first arc.' },
