const profileSeeds = [
  {
    ...
    personalitySummary: 'Lynleit places MSF duty and her personal missions above private wants. She studies hidden structures with private precision, interprets present events through their future consequences, and builds contingencies around the people for whom she feels responsible. She treats openness as a leadership skill and normally gives people the truth they need to act with her. Under mortal pressure, she rejects solutions that sacrifice someone under her protection, searches across every available discipline, and acts decisively. Her concealment in Doom Has an Address is a narrow exception caused by the sexual and personally humiliating nature of the plan.',
    traits: [
    ...
    ally: 'Kyrien', allyNote: 'Their connection begins with concealed personal stakes: his attack on an MSF-protected politician nearly harms Lynleit, but Kyrien never learns she was present. She later coerces him into service and keeps him hidden even from Fionn. Card games after the failed river watches create their first voluntary rhythm, while the operation turns their attention to bodily tells and physical distance. Kyrien protects her water-walking secret and eventually chooses to remain after her authority can no longer compel him. Near the end of Arc 1, destroying a Holumn together binds one fatal curse to both identities. Lynleit rejects the solution that one must die, investigates transformation as an alternative, and initiates their first sexual encounter when the prognosis falls to days. Their reciprocal change fractures the curse. Attraction never outranks her duty to MSF.', rival: 'Helena', rivalNote: 'Lynleit distrusts her stepmother before the takeover, then learns Helena played a major role in Fionn\'s assassination even though the full conspiracy remains unclear.', goal: 'Keep Kyrien hidden as leverage against Helena, restore legitimate leadership, protect their child, and investigate the Spill without revealing what her later appearances around MSF missions are meant to accomplish.',
  ...
  },
  {
    ...
    ally: 'Lynleit', allyNote: 'She begins as his coercive handler and privately knows that his attack almost harmed her. Card games after the failed river watches expose the tells each normally conceals. He later protects her water-walking secret, shelters her after Fionn\'s murder, and chooses to remain once her authority can no longer compel him. Near the end of Arc 1, their joint destruction of a Holumn binds one fatal curse to both identities. Kyrien knows the prognosis but not Lynleit\'s proposed answer. He notices her unusual behavior, asks about the curse without forcing an explanation, and deliberately answers her initiative. Their reciprocal change fractures the curse.', rival: 'Tien', rivalNote: 'A shadow operator whose methods mirror Kyrien\'s skills without his restraint, forcing him to sharpen every discipline that keeps him alive.', goal: 'Survive Lynleit\'s control, master the intelligence side of MSF, face the Magus politician tied to his father\'s death, and eventually make choices inside the hidden world on terms that are genuinely his own.',
  ...
  },
  {
    ...
    personalitySummary: 'Mikhail is patient when doctrine requires precision and blunt when the practical conclusion is simpler than the doctrine behind it. He can tolerate another person\'s anger without retreating from an answer, and irreverence appears only after he has established the mechanism with care.',
    tradecraft: [
