const profileSeeds = [
  ...
  },
  {
    ...
    connections: [
      { name: 'Lynleit', relation: 'Handler and eventual partner', detail: 'She begins as his coercive handler. After he alone witnesses her walking on water, he denies seeing anything and keeps the forbidden secret. Drenched and breathless, they sit back to back for warmth. Their bond grows through practical care before either expresses romantic intent. The hotel-room refuge follows much later after Fionn\'s murder, and they do not have sex until the end of the first arc.' },
