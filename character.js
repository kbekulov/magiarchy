const profileSeeds = [
  {
    ...
    beats: ['The Heir Apparent', 'The Accusation', 'Fugitive Counteroffensive', 'The Battle as Reward', 'Academy Intervention', 'Protected Absence and Inquiry', 'Seen at the Mission Edge']
  },
  {
  ...
  },
  {
    ...
    origin: 'Myka enters an Academy that functions as a public institution within Magi society. Magi families and lineages fund it so their children can succeed them, while acclaimed Magi who choose research and teaching serve as professors. Her aunt Natalia, a former professor, remains a constant source of advice and a personal connection to life beyond the institution.', rupture: 'Myka encounters terrors inside the Academy and must rely on Natalia for rescue and support. The threat turns formal study into a struggle for survival inside an institution meant to train and protect young Magi.', focus: 'Natalia and Myka eventually reach Lynleit, who agrees to send Kyrien into the Academy as an undercover helper. How the two women enter Lynleit\'s circle, what cover admits a non-Magus operative, and whether Natalia once taught Lynleit remain unresolved.', future: 'Myka survives the Academy crisis and graduates at the top of her class. MSF later recruits her as a strong Magus. Her recruitment most likely follows Lynleit\'s disappearance and Kyrien\'s assumption of the director\'s office, but that placement remains unresolved.',
  ...
  },
  {
    ...
    origin: 'Mikhail is trained as a priest for public cover and as a special envoy for the restricted operational needs of Church leadership. His specialization and exact authority are not yet known.', rupture: 'He becomes the first authority to discover that Lynleit has shared forbidden knowledge of magic with Kyrien, Felix, and Reiner. When she promises to contain the breach on her own terms, he warns that he may later be sent to clean up the consequences.', focus: 'Mikhail does not immediately seize control of Lynleit\'s witnesses. His judgment and final warning force her to accept that keeping them safe requires an institutional answer rather than another private promise.', future: 'The breach helps drive MSF toward a partly Magi function accountable to the Magiarchy and the Church. Mikhail may be required to act if Lynleit\'s solution fails, but the narrow authority that would govern such an assignment remains undefined.',
    ally: 'The Church', allyNote: 'The institution that trains, authorizes, and may later send him to contain the witness breach.', rival: 'Church doctrine', rivalNote: 'The authority that gives him purpose while limiting the mercy he can show.', goal: 'Prevent the hidden conflict from turning necessary secrecy into moral surrender.',
