const profileSeeds = [
  ...
  },
  {
    ...
    origin: 'Helena learns to read MSF as a hierarchy of loyalties rather than a simple intelligence service, but she never learns every protocol embedded by its founder.', rupture: 'Fionn\'s elimination creates the opening she needs to seize control and make Lynleit the official enemy.', focus: 'Her authority depends on keeping the accusation intact while the investigation exposes layers of conspiracy that may extend far beyond her own seizure of MSF. She does not know that blue clothing functions as a command-authentication signal among top officers.', future: 'Her ignorance has a political consequence. Influential officers begin to suspect that Fionn never intended Helena to inherit his director seat, because he did not entrust the rule to his wife while Lynleit continues to express it in exile. Helena can occupy the office, but the founder\'s private language quietly weakens her legitimacy.',
