const profileSeeds = [
  ...
  },
  {
    ...
    personalitySummary: 'Mikhail explains difficult doctrine patiently and can deliver a personal taunt with the solemn cadence of a blessing before dropping into blunt ordinary speech. He lets Lynleit be angry without withdrawing his advice. In the field, he survives confrontations with Magi even when operating alone.',
    tradecraft: [
    ...
    connections: [
      { name: 'Lynleit', relation: 'Cardiff counterpart and difficult penitent', detail: 'Lynleit reaches Mikhail after his foreign assignment becomes a life-and-death operation. They protect one another despite lasting moral incompatibility. He later confirms that the curse she shares with Kyrien can be broken through identity transformation and invokes her father\'s household in a mock blessing before giving the practical answer with a bluntness that leaves her furious.' }
    ],
