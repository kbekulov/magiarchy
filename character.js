const profileSeeds = [
  {
    ...
    appearanceDetails: [
      ...
      ['Arc 2 elusive appearance', 'In Arc 2, Lynleit wears her ash-black hair in a compact bun. She wears a high-necked black top beneath a short cape-like mantle, fitted black shorts, dark tights, gloves, over-the-knee lace-up boots, and a vivid blue sash at the waist.']
    ],
    equipment: [
    ...
    personalitySummary: 'Lynleit puts MSF and her own missions first. She shares her thinking with the people she leads. When uncertain, she feels there is an answer even though she cannot yet explain it. Talking to someone she trusts helps bring it into focus; she tries not to show how much the uncertainty troubles her. In private she is reserved and reflective. Personal embarrassment makes her evasive or irritable, especially when Kyrien notices it. Mikhail gets formal objections, sharp retorts, and eventually a carefully worded threat.',
    traits: [
    ...
    origin: 'Lynleit is associated with the Cult of Inanna through Fionn\'s lineage, without directly participating in it. She grew up close to MSF leadership. Felix and Reiner became her friends and the bodyguards Fionn trusted with her safety. At the Magi Academy, Natalia was her favourite teacher. She distrusted Helena before any open conspiracy, noticing her stepmother\'s questions about Fionn\'s schedules, visitors, trusted officers, and Lynleit\'s travel. At the Prosecutor General\'s appointment dinner, Kyrien\'s failed attack nearly harms her. She never tells him she attended. His represented interrogation reveals years of work paying lawyers and caring for his mother. She recognizes suppression behind his father\'s persecution and keeps that knowledge from him. Guilt, admiration of his competence, and her warning of approaching danger lead her to offer paid confidential service and limited help obtaining release. She tells only Felix and Reiner in her circle.', rupture: 'Days before Fionn\'s death, the Nameless Street leaves Lynleit with the memory of a dead boy below a broken fence. Seeing her father\'s body below the hill at the family house brings the memory back. Helena uses her stunned reaction to support the accusation that Lynleit killed him. Hunted and out of resources, Lynleit reaches Kyrien\'s hotel-room hideout. He helps her reconnect with Felix and Reiner. Fionn\'s old officers begin questioning Helena when Lynleit can answer his private recognition challenge and Helena cannot.', focus: 'During the river operation, the Drowned Choir drags Lynleit underwater and tears away her blue suede jacket. She burns the hands with blue flame, breaks the surface, and stands on the water. Kyrien sees her from the park bank. It is his first unmistakable exposure to magic; he tells nobody, and she initially only suspects what he saw. Father Mikhail later discovers that Kyrien, Felix, and Reiner know about magic. Lynleit insists on handling the breach herself. When the Church and Magiarchy send her to assist Mikhail in Cardiff, she sends Kyrien to help Myka at the Academy. She underestimates the danger there. In Cardiff, she and Mikhail protect one another despite their incompatible methods.', future: 'Midway through Arc 1, after Fionn\'s death, Lynleit discovers that he replaced her coat with a leviathan-hide garment. Later in the second half of Arc 1, she and Kyrien survive a shared curse after an incomplete attempt at intimacy. She refuses to discuss it with him even after the curse is gone. Their sexual relationship begins later. Near the Arc 2 transition she disappears. She bears their son during her absence and keeps him hidden from Kyrien and the wider world while raising him, recovering, and seeking answers about the Spill. Years later she begins appearing around MSF missions without explaining her return. During Arc 2 they restore intimacy; this eventually leads to the conception and later birth of their daughter, their second child.',
    connections: [
      { name: 'Felix', relation: 'Long-standing friend and bodyguard', detail: 'Their friendship allows teasing, blunt correction, and easy physical familiarity. He and Reiner accompany her and Fionn on church visits. Felix repeatedly flirts with nuns while Reiner behaves, eventually exhausting her patience. When she catches him by his tie, he answers with a declaration of attention to her. She rejects his reading of the reprimand.' },
      ...
      { name: 'Kyrien', relation: 'Strategic recruit and eventual partner', detail: 'She recruits him deliberately for strategic reasons, without anticipating their eventual closeness. Card games, shared work, and his protection of her water-walking secret bring private familiarity. He shelters her after Fionn\'s death and chooses to remain when she can no longer compel him. Her initiative, pride, and curiosity meet his reserve and close observation. Gradually each allows the other to notice what they would usually conceal, and quiet companionship becomes important without displacing her duties.' },
      { name: 'Natalia', relation: 'Favourite teacher and friend', detail: 'Lynleit jokes with Natalia, challenges her conclusions, and readily returns to her for help. She follows her explanations with a student\'s curiosity rather than a subordinate\'s deference. Natalia taught her at the Magi Academy, later asks her to help Myka, and identifies ego transformation as a possible way to survive the shared curse.' },
      { name: 'Father Mikhail', relation: 'Cardiff counterpart and theological adviser', detail: 'The Magiarchy and Church send Lynleit to assist Mikhail abroad. They protect one another despite a moral rift, and he later finds related cases in Church records and proposes reciprocal identity change as a possible way out of the shared curse. His mock blessing names her lineage\'s association with the Cult of Inanna. She objects to his use of family history as a personal obligation and threatens a reprisal if he repeats the address publicly.' }
    ],
    ...
    timelineNotes: {"The Heir Apparent":"Grows up as Fionn's daughter and studies magecraft under Natalia.","The River Secret":"Survives the Drowned Choir; Kyrien witnesses her walking on water.","Cardiff with Father Mikhail":"Assists Mikhail abroad without MSF's conventional resources.","Academy Intervention":"Sends Kyrien to help Myka while she is away.","The Accusation":"Helena blames her for Fionn's death.","Fugitive Counteroffensive":"Escapes to Kyrien and reconnects with Felix and Reiner.","The Battle as Reward":"Asks Kyrien why he keeps accepting danger without a promised reward.","Doom Has an Address":"Survives a shared curse in the later part of Arc 1’s second half, after the hotel refuge. Exact placement remains open.","Protected Absence and Inquiry":"Leaves near the Arc 2 transition to raise her son and investigate the Spill.","Seen at the Mission Edge":"Reappears around MSF operations without announcing her return.","Arc 0: Formative Years":"Development outline: continuing grief, a changing household, and school years before the main story.","The Bench under the Lamp":"Months after Doom, private research and spontaneous closeness lead to a successful encounter in the park, before later intercourse."},
  ...
  },
  {
    ...
    tradecraft: [
      ...
      { label: 'Escape discipline', title: 'Evasion', detail: 'Studies surveillance and plans exits before entry. He looks for ways to change the terms of a confrontation, though his urge to win can draw him into one he would otherwise avoid.' },
      ...
      { label: 'Experience with lawyers', title: 'Caution under questioning', detail: 'Years financing his father\'s case teach him to follow legal advice and recognize invitations to incriminate himself. Lawyers do the legal research and procedural work. His own contribution is persistence, family records, recollection, and practical observation.' },
      ...
      { label: 'Last resort', title: 'Survival combat', detail: 'Uses practical close combat and terrain awareness to remain mobile, evade a stronger opponent, or reach an escape route.' },
    ...
    origin: 'Kyrien\'s father is a Narvean military-police commander who teaches him about weapons and officer conduct. At five, Kyrien points a Sparrow at a civilian and is sharply corrected. Years later, his father survives a fugitive\'s assault while protecting his officers, kills the fugitive in self-defence, and witnesses magic. He tells nobody. Officials connected to the Magiarchy fabricate a prosecution, then obtain sanction to murder him and present his death as suicide. His mother increasingly struggles with ordinary life, and he takes on much of her care. Kyrien works extra shifts and jobs to support her and pay competent lawyers. Their evidence prompts an inquiry that confirms deliberate distortion, but a closed national-security review protects the senior prosecutor and publicly vindicates him. Kyrien continues working and caring for his mother. Only later, after strangers humiliate her in a shop and she apologizes for failing to manage the shopping, does he decide to kill the prosecutor.', rupture: 'The prosecutor is promoted to Prosecutor General. Kyrien\'s attempt at the appointment dinner fails partly because of a concealed connection to the magical world, without revealing magic to him. He escapes and is detained later on suspicion, not a conclusive case. Lynleit was nearly harmed at the dinner, but never tells him she attended. With his lawyer still representing him, she questions him and recognizes the suppressed injustice behind his family\'s case. She offers help obtaining release, paid confidential work, and arrangements for his mother\'s care, without unconditional immunity. He agrees reluctantly after negotiating the terms. Fionn is not told; Lynleit tells only Felix and Reiner in her circle.', focus: 'Felix clashes with Kyrien; Reiner remains watchful but accepts Lynleit\'s decision. During the failed river watches, Kyrien plays cards with her and begins learning her tells. Seeing her walk on water is his first unmistakable exposure to magic. He tells nobody; she initially only suspects what he saw. When Mikhail questions her about the breach, however, Kyrien tells him that Felix and Reiner also know. While Lynleit is in Cardiff, Kyrien protects Myka undercover at the Academy, relying on Felix and Reiner until Natalia intervenes. After Fionn\'s death he shelters Lynleit and helps her reconnect with the officers. Asked why he keeps risking his life without a reward, he answers: "Because there\'s a battle to be fought."', future: 'Much later, once both openly acknowledge his knowledge of Magi, Lynleit offers a possibility of revenge against the Prosecutor General for a separate new offence, conditional on genuine proof. Kyrien recognizes her manipulation. Punishment need not bring any acknowledgment of the wrong done to his father. Kyrien stays with Lynleit after she loses the authority to compel him. They survive a shared curse following an incomplete attempt at intimacy, but she will not explain the proposed treatment. Months after Doom, the spontaneous park encounter becomes their first successful sexual act, distinct from later intercourse. When Lynleit inherits the Magiarchate and then disappears, Kyrien becomes director of MSF. He must manage its government contracts, divided loyalties, ordinary intelligence work, and response to the Spill without her magical authority. He does not know that Lynleit bore their son during her disappearance. She continues to keep the child hidden from him and the wider world. During Arc 2 they restore intimacy and eventually conceive a daughter, who is born later. They have two children by the end of their story.',
    connections: [
      {"name":"Their son","relation":"First child","detail":"Born during Lynleit's disappearance and kept hidden from Kyrien and the wider world afterward."},
      {"name":"Their daughter","relation":"Second child","detail":"Conceived after intimacy is restored during Arc 2 and born later."},
      { name: 'Lynleit', relation: 'Handler and eventual partner', detail: 'She questions him knowing that his failed attack nearly harmed her, a fact he never learns. Their repeated card games create a voluntary contest inside the coerced arrangement. He later protects her water-walking secret, gives her refuge, and chooses to remain once her authority can no longer compel him. In the later part of Arc 1\'s second half, one curse binds their identities after they destroy a Holumn together. Lynleit attempts intimacy without revealing the proposed treatment. The incomplete attempt is followed by recovery, leaving Kyrien with questions she will not answer. Their closeness also requires him to accept being recognized and challenged. His reserve does not always protect him from her attention, and remaining beside her gradually permits responses he would otherwise conceal.' },
      { name: 'Kyrien\'s father', relation: 'Formative authority', detail: 'A military-police commander who introduces Kyrien to weapons, protocol, and officer morality. His correction of Kyrien\'s first reckless act with a Sparrow becomes the foundation of his son\'s belief that using force also means accepting reciprocal danger.' },
      { name: 'Kyrien\'s mother', relation: 'Continuing family responsibility', detail: 'His father\'s death and disgrace leave her increasingly unable to manage ordinary life. Kyrien cares for her while working to fund legal representation. Her tastes, habits and attempts at independence persist; her care and his income remain obligations after recruitment.' },
    ...
    ally: 'Lynleit', allyNote: 'Lynleit recruits him while he faces continued detention, with his lawyer negotiating pay and provision for his mother. He later chooses to stay, keeps her forbidden ability secret, and gives her refuge. After their shared curse ends, she refuses to explain why she tried to sleep with him. He suspects a connection between the attempt and their recovery.', rival: 'Tien', rivalNote: 'Tien serves Helena as a concealed assassin. Kyrien must contend with an opponent who also relies on deception and surprise.', goal: 'Survive Lynleit\'s control, master the intelligence side of MSF, pursue the Prosecutor General responsible for his family\'s destruction without abandoning his mother, and eventually make choices inside the hidden world on terms that are genuinely his own.',
    timelineNotes: {"Outside the System":"Works for years to support his mother and finance lawyers. After institutional refusal and her later humiliation, he attempts to kill the newly appointed Prosecutor General.","Alliance under Pressure":"Accepts paid confidential work and support for release, with his lawyer negotiating terms and care for his mother.","The Battle as Reward":"Tells Lynleit that a battle is reason enough to fight.","Undercover at the Academy":"Protects Myka until Natalia can intervene.","One Curse across Two Identities":"Survives the curse but does not learn why Lynleit attempted intimacy.","The Director without Magecraft":"Takes over MSF while Lynleit is absent.","The Secret Kept from Him":"Remains unaware that Lynleit bore his son.","Arc 0: Formative Years":"Tentative prequel: family life before recruitment; the age and Arc of his father's death remain undecided.","The Bench under the Lamp":"Shares a private encounter with Lynleit months after Doom, then gives her his flask without pressing for an explanation."},
    ...
    beats: ['Arc 0: Formative Years', 'Outside the System', 'Alliance under Pressure', 'The Battle as Reward', 'Undercover at the Academy', 'One Curse across Two Identities', 'The Bench under the Lamp', 'The Director without Magecraft', 'The Secret Kept from Him']
  },
  {
    ...
    timelineNotes: {"Reading the Institution":"Studies Fionn's movements and loyalties.","The Opening":"Assists part of the conspiracy against him.","Control through Accusation":"Seizes MSF and directs the hunt for Lynleit.","A Throne under Pressure":"Fionn's old officers question her ignorance of his private protocol.","Arc 0: Formative Years":"Development outline: entering a bereaved household and building a life with Fionn."},
    ...
    beats: ['Arc 0: Formative Years', 'Reading the Institution', 'The Opening', 'Control through Accusation', 'A Throne under Pressure']
  },
  {
  ...
  },
  {
    ...
    beats: ['Arc 0: Formative Years', 'Two Offices', 'The Hidden Purpose of MSF', 'Conflict behind the Mask', 'The Inheritance after Death']
  },
  {
  ...
  },
  {
    ...
    conflicts: [["Unauthorized agreement","Her private approach to MSF would be stopped if the Court or government discovered it."], ["Uneven attachment","Felix becomes increasingly important to her while remaining fixated on Lynleit. Sherie has limits to what attention she will accept; she wants to be seen clearly, not simply enjoyed as a diversion."]],
  ...
  },
  {
    ...
    traits: [
      ...
      { label: 'Troublemaker', note: 'Felix has difficulty resisting a chance to flirt even when the setting calls for restraint. During church visits with Lynleit, Fionn, and Reiner, his repeated advances to nuns become a recurring source of trouble.' },
    ...
    conflicts: [["Lynleit's judgment","His distrust of Kyrien brings him into conflict with the friend he wants to protect."], ["Attachment to Lynleit","His hopes remain centered on Lynleit while familiarity and affection grow with Sherie. Reciprocating Sherie's teasing is easier than recognizing how important she has become to him."]],
  ...
  },
  {
    ...
    personalitySummary: 'Reiner is stern and rarely smiles. He follows procedure, respects the chain of command, and takes duty and legitimate authority seriously. A small break in his composure is conspicuous beside Felix\'s constant play. In the field he commits to the direct line: the rook that holds a position or breaks through it.',
    traits: [
      ...
      { label: 'Severe composure', note: 'Reiner is restrained, difficult to fluster, and rarely seen smiling even among people he trusts. When he and Felix accompany Lynleit and Fionn to churches, Reiner behaves appropriately while Felix keeps flirting with the nuns.' },
  ...
  },
  {
    ...
    traits: [
      ...
      { label: 'Magical examination', note: 'She examines unusual magecraft and personal deviations closely, studying the affected person as well as the circumstances of the incident.' },
    ...
    ally: 'Lester', allyNote: 'Lester is not her employee. He is an outside ally and a demiholumn whose part-Holumn nature sometimes allows him to accomplish what should be impossible for an ordinary investigator. Their repeated work carries sexual tension because her effort to understand him cannot remain entirely separate from personal attention.', connections: [
      ...
      { name: 'Lynleit', relation: 'Former student and friend', detail: 'Natalia teaches through examples Lynleit can work through, including her own failed approaches. Lynleit teases her, offers playful objections, and trusts her enough to keep asking difficult questions. Their friendship is informal; Natalia\'s greater experience remains evident in the corrections and connections Lynleit learns from her. They work together over Myka\'s danger and the curse Lynleit shares with Kyrien.' }
  ...
  },
  {
    ...
    personalitySummary: 'Lester likes novelty, conflict, and finding out what happens when he gets involved. That appetite takes him into situations Natalia cannot reach through scholarship alone. His own history defeats both of them: its events cannot fit into one continuous chronology.',
    traits: [
    ...
    nature: [
      ...
      { label: 'Unresolved boundary', title: 'Human agency inside a Holumn nature', detail: 'Neither Lester nor Natalia knows the full extent or cost of his demiholumn nature.' }
    ],
    origin: 'Lester is a demiholumn, half human and half Holumn. Neither he nor Natalia knows how he became one. Chronological factors in his biography contradict continuity itself; his history cannot be reconciled into a conventional causal timeline. Understanding how he came into existence lies beyond the horizon of human singularity and normal human comprehension.', rupture: 'He becomes Natalia\'s ally without becoming her employee. When one of her cases reaches an impossible barrier, his unusual nature can provide an answer that neither ordinary investigation nor conventional magecraft could reach.', focus: 'Lester\'s unusual abilities help Natalia with otherwise impossible cases. He also pushes back against her habit of examining him and notices when her attention becomes personal.', future: 'His working relationship with Natalia develops sexual tension. Natalia comes to recognize contradiction as an intrinsic feature of nature, rather than treating his existence as an error in reality. His origin is not reducible to a discoverable transformation, experiment, infection, or ordinary supernatural mechanism. The limits of his abilities remain unknown.',
    ...
    timelineNotes: {"Between Human and Holumn":"Lives as a demiholumn whose biography cannot form a continuous causal chronology.","Natalia's Outside Ally":"Helps Natalia without joining her business.","The Impossible Favor":"Uses his unusual nature when her casework meets an impossible obstacle.","A Nature without an Explanation":"Natalia recognizes his contradiction as intrinsic to nature, without explaining his origin."},
  ...
  },
  {
    ...
    connections: [
      { name: 'Lynleit', relation: 'Cardiff counterpart and difficult penitent', detail: 'Lynleit reaches Mikhail after his foreign assignment becomes a life-and-death operation. They protect one another despite lasting moral incompatibility. He later proposes identity transformation as a possible way to break the curse she shares with Kyrien and invokes her lineage\'s Cult of Inanna association in a mock blessing before giving the practical answer with a bluntness that leaves her furious.' }
    ],
