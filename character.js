const profileSeeds = [
  ...
  },
  {
    ...
    personalitySummary: 'Natalia is a researcher first and a private investigator by necessity. She protects her intellectual autonomy and studies unusual systems without needing institutional agreement. She explains difficult ideas through worked examples and experiences from her own research, including failed approaches and corrections. She asks the listener to try the next step, admits what she cannot establish, and enjoys a good objection. With Lynleit, the lesson includes familiar teasing and the easy affection of a teacher and former student who remain friends.',
    traits: [
  ...
  },
  {
    ...
    personalitySummary: 'Lester seeks stimulation, novelty, conflict, and direct engagement with whatever stands in front of him. His appetite for immediate experience gives Natalia an ally willing to enter situations that scholarship alone cannot reach. His immediate appetite coexists with a biography whose chronology cannot form a continuous causal history.',
    traits: [
