const profileSeeds = [
  {
    ...
    origin: 'Lynleit is Fionn\'s biological daughter and intended heir. Helena is her stepmother, not her biological mother. Raised close to MSF leadership, Lynleit inherits Fionn\'s blue-flame magecraft, while a childhood fear of drowning independently manifests as the forbidden ability to walk on water. Felix and Reiner are already her close, long-standing friends before the story begins, as well as the personal bodyguards Fionn trusts with her safety. Natalia was Lynleit\'s favourite teacher during her Magi Academy years. Her relationship with Helena is always tense. Before any open conspiracy, Lynleit notices Helena repeatedly probing details that seem domestic in isolation: Fionn\'s schedules, visitors to the house, officers he trusts, and Lynleit\'s own travel. She begins to suspect murder because somebody is studying her family too carefully. Within the first few chapters, Kyrien attacks a Magus politician under MSF protection and almost harms Lynleit during the failed attempt. She knows how close he came; he does not know she was present, and she never tells him. Lynleit later questions him with that private injury behind her authority, then uses an extraordinary transfer clause in MSF\'s government service contract to recruit him as her first deeply anti-protocol MSF decision. She eventually limits the truth to Felix and Reiner without informing even Fionn.', rupture: 'Days before Fionn\'s death, the Nameless Street leaves Lynleit with the memory of a dead boy below a broken fence. When Fionn is later found below the hill at the family house, the resemblance stupefies her and allows Helena to give a false meaning to a genuine reaction. The still-unresolved conspiracy vindicates Lynleit\'s warning without implying that she foresaw its exact form. Helena takes control, frames Lynleit for his death, and directs a hunt for her arrest. Lynleit exhausts her available resources to escape and reaches Kyrien\'s hotel-room hideout, where her composure finally breaks. He later helps her establish contact with Felix and Reiner, beginning her slow effort to reclaim MSF while she remains hunted. Lynleit continues initiating Fionn\'s blue recognition sequence on the run. His most conservative old officers recognize the conversational response that Helena cannot give and begin to treat obedience to the founder\'s protocol as a reason to question his official successor.', focus: 'During the failed river watches, short card games after each aborted operation become Lynleit and Kyrien\'s first voluntary routine. She learns the stopped breath before one of his risks, while he learns the small hand movement before one of her decisions. The attraction produced by that attention remains involuntary for Lynleit and never outranks the operation. On the fifth watch, Kyrien briefly steadies her near the Sparrow holster when an empty boat shifts, then is driven toward the quarantined park bank when the Drowned Choir attacks. Reiner, Maren, and Ivo reach Felix on the city bank. The hands drag Lynleit underwater, tear away her fitted blue suede jacket, and trigger fury alongside her childhood fear of drowning. Her blue flame burns the hands even beneath the water. After she breaks the surface, it supports her palm, knee, and boots until she stands above hands that cannot cross the surface layer. Only Kyrien sees the forbidden act. Lynleit later reaches him inside the night park, where their awareness of each other\'s breathing continues while they sit back to back for warmth. His careful denial protects her secret. Father Mikhail later discovers that she has shared forbidden knowledge with Kyrien, Felix, and Reiner. Her refusal to surrender or suppress them begins the pressure to create a formal Magi role for MSF. During Father Mikhail\'s Arc 1 venture in Cardiff, the Magiarchy and Church send Lynleit to assist him. Abroad and without MSF or its conventional arsenal, she must rely on her Magus training. She and Mikhail continue protecting one another and completing their missions even after their morally incompatible methods become impossible to ignore. Before leaving Narvea, Lynleit answers Natalia\'s request by sending Kyrien to help Myka at the Academy in her place. She understates the danger and expects the assignment to teach him more about the Magi world.', future: 'Lynleit later complains about losing the blue suede jacket because she liked it. Midway through Arc 1, after Fionn\'s death, she discovers that he had discreetly replaced her blue coat with a protective garment made from the hide of leviathan. The coat changes form by its own judgment and sometimes imitates the lost jacket, but protection requires Lynleit to use it actively rather than simply wear it. When Lynleit\'s authority over Kyrien can no longer compel him, he chooses to remain in the counteroffensive. Their relationship becomes sexual only at the end of Arc 1, after intimacy has accumulated inside their work through unfinished contests, practical care, danger, and voluntary loyalty. Lynleit disappears near the transition into Arc 2. The opening of Arc 2 supplies the circumstances from which her pregnancy can be inferred without showing or explaining it directly. She remains away to keep the child beyond the conflict\'s reach, recover, and consult wiser people about the Spill\'s origins. Years later she does not announce a return. She appears around MSF missions, sometimes seemingly by accident and sometimes by design, and her unexplained presence can make her look like a culprit.',
    connections: [
      { name: 'Natalia', relation: 'Former favourite teacher', detail: 'Natalia taught Lynleit at the Magi Academy and later asks her to help Myka. Lynleit answers the request by sending Kyrien before leaving for Cardiff.' },
      { name: 'Father Mikhail', relation: 'Cardiff counterpart', detail: 'The Magiarchy and Church send Lynleit to assist Mikhail abroad. They protect one another and complete the mission despite a growing moral rift between their methods.' }
    ],
    ally: 'Kyrien', allyNote: 'Their connection begins with concealed personal stakes: his attack on an MSF-protected politician nearly harms Lynleit, but Kyrien never learns she was present. She later coerces him into service and keeps him hidden even from Fionn. Card games after the failed river watches create their first voluntary rhythm, while the operation turns their attention to bodily tells and physical distance. When she asks why he keeps risking his life without reward, his answer, \"Because there\'s a battle to be fought,\" makes clear that the fight itself draws him forward. Kyrien later protects her water-walking secret and eventually chooses to remain after her authority can no longer compel him. Lynleit never makes attraction a priority over MSF, and the relationship remains non-sexual until the end of Arc 1.', rival: 'Helena', rivalNote: 'Lynleit distrusts her stepmother before the takeover, then learns Helena played a major role in Fionn\'s assassination even though the full conspiracy remains unclear.', goal: 'Keep Kyrien hidden as leverage against Helena, restore legitimate leadership, protect their child, and investigate the Spill without revealing what her later appearances around MSF missions are meant to accomplish.',
    beats: ['The Heir Apparent', 'The River Secret', 'Cardiff with Father Mikhail', 'Academy Intervention', 'The Accusation', 'Fugitive Counteroffensive', 'The Battle as Reward', 'Protected Absence and Inquiry', 'Seen at the Mission Edge']
  },
  {
    ...
    origin: 'Kyrien begins the story as an independent figure and the son of a Narvean military commanding officer. His father introduces him to weapons and officer conduct unusually early. At five, Kyrien is allowed to hold a Sparrow and immediately aims it at a civilian in the street. His father stops and scolds him, making clear that familiarity with a weapon never permits a breach of protocol. The incident leaves Kyrien with a quiet affinity for military practice and the moral burden attached to force. After his father\'s death, he retains that mentality alongside access to surviving contacts, suppliers, knowledge, and tools. The inheritance later enables his attempt on a politician involved in causing his father\'s death. The target is under MSF protection. The attempt fails because the politician belongs to the Magi world, and Kyrien never learns that Lynleit was present and almost harmed by his actions.', rupture: 'Within the first few chapters, the failed attempt ends with Lynleit interrogating Kyrien at a police office. She invokes an extraordinary transfer clause in MSF\'s government service contract, drafted under Fionn for extraordinary threats, taking control of the case and offering conditional freedom: become her secret helper and remain confined to her demands. Kyrien cannot account for the personal edge in her questioning because Lynleit never tells him what happened. The contract authority shaped under Fionn lets his daughter recruit a man she deliberately hides from him. She wants a deniable trump card against Helena and eventually tells only Felix and Reiner.', focus: 'The coerced arrangement drags him deeper into the world of Magi and gradually into MSF. Reiner remains suspicious but accepts Lynleit\'s judgment. Felix never fully trusts him and repeatedly clashes with him, leaving Kyrien inside a circle whose members protect Lynleit from him as much as they protect him for her. Short card games after the failed river watches expose Kyrien\'s private need to win. He usually wins through technical play, while Lynleit learns his stopped breath before a risk and turns his own attention toward her hands, gaze, and stillness. During the fifth watch, he briefly steadies her near the concealed Sparrow when an empty boat shifts. After the river separates him from the team, he witnesses her forbidden water walking and protects the secret. Father Mikhail later exposes the witness breach, and Kyrien refuses to preserve Lynleit\'s convenient half-truth about Felix and Reiner. While Lynleit is sent to Cardiff, she assigns Kyrien to protect Myka undercover at the Magi Academy. He depends on conventional field skills and communications with Felix and Reiner until the danger exceeds Lynleit\'s estimate and Natalia intervenes personally. The operation becomes his first sustained experience inside Magi education and Myka\'s first experience with him and MSF. When Lynleit finally asks why he keeps accepting danger without any reward waiting for him, he answers without hesitation: "Because there\'s a battle to be fought." He treats the fight itself as sufficient reward. The answer leaves open whether he is proving himself to his own standards or still measuring himself against his dead father. After Helena frames Lynleit and launches the hunt for her arrest, Kyrien gives her refuge and helps her find secure ways to contact the two officers. His hidden position becomes the first practical base of her campaign to reclaim MSF.', future: 'When Lynleit\'s institutional authority can no longer enforce their original bargain, Kyrien receives a real opportunity to leave and chooses to remain in the counteroffensive. The decision makes his loyalty voluntary before their relationship becomes sexual. After Fionn\'s death, Lynleit eventually inherits the Magiarchate as Narvea\'s new Magiarch. While that office keeps her away from MSF, Kyrien inherits the director\'s seat, despite being a non-Magus who began as an unofficial asset hidden from Fionn. He must hold together a private company, its government contracts, its divided loyalties, and its permanent mandate against the Spill while the person who connects MSF to the hidden magical order is absent. He survives by reaching the peak of MSF\'s intelligence-operative side, learning to make decisions without Lynleit\'s intuition or magical authority and to keep both ordinary intelligence work and Magi-focused containment functioning at once. Lynleit later begins appearing around missions, while Kyrien remains unaware that they have a son.',
    connections: [
      { name: 'Lynleit', relation: 'Handler and eventual partner', detail: 'She questions him knowing that his failed attack nearly harmed her, a fact he never learns. Their repeated card games after the failed river watches create a voluntary contest inside the coerced arrangement. He later protects her water-walking secret, gives her refuge after Fionn\'s murder, and chooses to remain once her authority can no longer compel him. They do not have sex until the end of Arc 1.' },
    ...
    ally: 'Lynleit', allyNote: 'She begins as his coercive handler and privately knows that his attack almost harmed her. Card games after the failed river watches expose the tells each normally conceals. When she asks why he accepts danger without reward, he answers that there is a battle to be fought. He later protects her water-walking secret, shelters her after Fionn\'s murder, and chooses to remain once her authority can no longer compel him. Their relationship remains non-sexual until the end of Arc 1.', rival: 'Tien', rivalNote: 'A shadow operator whose methods mirror Kyrien\'s skills without his restraint, forcing him to sharpen every discipline that keeps him alive.', goal: 'Survive Lynleit\'s control, master the intelligence side of MSF, face the Magus politician tied to his father\'s death, and eventually make choices inside the hidden world on terms that are genuinely his own.',
    beats: ['Outside the System', 'Alliance under Pressure', 'The Battle as Reward', 'Undercover at the Academy', 'The Director without Magecraft', 'The Secret Kept from Him']
  },
  {
  ...
  },
  {
    ...
    personalitySummary: 'Tien trusts immediate perception and decisive movement. Danger sharpens rather than interrupts the work, and changing conditions become material for improvisation instead of reasons to pause.',
  ...
  },
  {
    ...
    ally: 'Lester', allyNote: 'Lester is not her employee. He is an outside ally and a demiholumn whose part-Holumn nature sometimes allows him to accomplish what should be impossible for an ordinary investigator. Their repeated work carries sexual tension because her effort to understand him cannot remain entirely separate from personal attention.', connections: [
      ...
      { name: 'Lynleit', relation: 'Former favourite student', detail: 'Natalia taught Lynleit at the Magi Academy and later asks her to intervene when Myka faces danger inside the institution.' }
    ...
    beats: ['Professor at the Academy', 'Scholarship without Permission', 'The Examiner for Hire', 'Myka\'s Academy Crisis', 'The Demiholumn Ally']
  },
  {
  ...
  },
  {
    ...
    beats: ['A Keeper of Restricted Truth', 'The Cardiff Venture', 'Lynleit Arrives', 'Methods in Conflict', 'Consequences in Narvea']
  },
  {
...
function renderProfile(profile) {
  ...
  ].filter(([name]) => !mappedRelationships.some((mapped) => relationshipTextMentions(name, mapped.name))).forEach(([name, relation, detail]) => {
