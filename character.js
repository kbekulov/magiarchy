const profileSeeds = [
  ...
  },
  {
    ...
    summary: 'A patient political operator who converts the vacuum after Fionn\'s elimination into control of MSF, then tries to remove Lynleit by framing her for his death.',
  ...
  },
  {
    ...
    summary: 'Publicly the director of MSF and secretly the country\'s Magiarch, Fionn faces pressure from Magiarchs abroad and several churches while their conflict is disguised as political chaos inside Narvea.',
    ...
    origin: 'Fionn creates MSF with a public intelligence purpose and a hidden structure prepared for magical crisis. Within his family, he is also the virtuoso of a hereditary blue-flame magecraft defined by control and subtle application.', rupture: 'Foreign Magiarchs and several churches turn their conflict with Fionn into political pressure inside Narvea. The manufactured strife occupies both of his offices when the Spill requires him most.', focus: 'The conspiracy remains difficult to confront because Magi shape its layers, false causes, and mortal intermediaries. The secrecy protecting Fionn\'s offices also prevents either institution from understanding the conflict carried between them.', future: 'His successful elimination turns unfinished plans and an obscured enemy network into an inheritance Lynleit and Kyrien must interpret without him.',
    ally: 'Lynleit', allyNote: 'His intended successor, though much of what she inherits was never fully explained.', rival: 'Foreign Magiarchs', rivalNote: 'Magiarchs abroad and manipulative actors across several churches bury their conflict with Fionn beneath a political threat Narvea can see.', goal: 'Protect Narvea from a magical conflict whose participants can manufacture ordinary political reality as cover.',
  ...
  },
  {
    ...
    origin: 'Sherie trains under her uncle Drake to become a successful diplomat. Their age gap matters less than the complement between his strategic mind and her instinctive command of social atmosphere.', rupture: 'Drake\'s peers ridicule his warning and the Duke remains skeptical, leaving Sherie to believe her uncle, recognize the opening his reputation cannot reach, and propose contact outside official supervision.', focus: 'She persuades Drake to meet Lynleit and takes charge of the negotiations herself. The meeting demonstrates why they work as a team: Drake understands the strategic stakes, while Sherie makes the dangerous conversation possible.', future: 'The failed boat infiltration proves that the suspected coup cannot be understood as a purely political operation and gives her diplomatic training a conflict no normal protocol anticipated.',
  ...
  },
  {
    ...
    summary: 'A State Councillor whose unusually close friendship with the Duke grants him rare access and occasional forgiveness, while leaving him shunned at Court as the Duke\'s favorite boy.',
    ...
    personalitySummary: 'Drake possesses a strong strategic mind but lacks the social instincts needed to make difficult people accept what he sees. His friendship with the Duke grants him unusual access and occasional forgiveness, while his niece Sherie supplies the charm and quick interpersonal judgment his plans often need.',
    origin: 'Drake reaches the rank of State Councillor while developing an unusually direct relationship with the Duke. He also begins training his niece Sherie for diplomacy, passing on institutional strategy while relying on her to understand the social terrain he routinely mishandles.', rupture: 'He reads the park disappearances as cover for illegal material movement, but his peers ridicule the theory and the Duke remains skeptical. The Court\'s existing resentment makes his warning easier to dismiss as another indulgence granted to a favorite.', focus: 'After formal authority leaves him isolated, he accepts Sherie\'s proposal for an illegal meeting with Lynleit. Drake defines the strategic request, but his apprentice takes control of the human negotiation needed to make it possible.', future: 'The failed boat infiltration opens his investigation toward a hidden force that political analysis alone cannot contain.',
