const profileSeeds = [
  ...
  },
  {
    ...
    timelineNotes: {"Outside the System":"Retains his father's military contacts and attempts to kill the politician implicated in his death.","Alliance under Pressure":"Accepts Lynleit's offer of conditional freedom.","The Battle as Reward":"Tells Lynleit that a battle is reason enough to fight.","Undercover at the Academy":"Protects Myka until Natalia can intervene.","One Curse across Two Identities":"Survives the curse but does not learn why Lynleit attempted intimacy.","The Director without Magecraft":"Takes over MSF while Lynleit is absent.","The Secret Kept from Him":"Remains unaware that Lynleit bore his son.","Arc 0: Formative Years":"Development outline: family loss and learning the limits of protecting his mother and sister alone.","The Bench under the Lamp":"Shares a private encounter with Lynleit months after Doom, then gives her his flask without pressing for an explanation."},
