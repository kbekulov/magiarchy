const profileSeeds = [
  ...
  },
  {
    ...
    ally: 'Lynleit', allyNote: 'She begins as his coercive handler. During the river operation, he reaches the quarantined park bank while the officers reach the city side, then observes her walking on water from inside the trees. Lynleit later joins him on the park side. He denies seeing anything and keeps the forbidden secret while they sit back to back for warmth, drenched and breathless. Their bond grows through practical care before either expresses romantic intent. The hotel-room refuge follows much later after Fionn\'s murder, and they do not have sex until the end of the first arc.', rival: 'Tien', rivalNote: 'A shadow operator whose methods mirror Kyrien\'s skills without his restraint, forcing him to sharpen every discipline that keeps him alive.', goal: 'Survive Lynleit\'s control, master the intelligence side of MSF, face the Magus politician tied to his father\'s death, and eventually make choices inside the hidden world on terms that are genuinely his own.',
