...
- Keep `The Duchy` as a top-level navigation item linking to `duchy.html`. Maintain its concise, bespoke country-profile layout, its breadcrumb back to Docs, and explicit placeholders for the country map and the Rennel, Vilen, and Turon city images until approved artwork is supplied.
