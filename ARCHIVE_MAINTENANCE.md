...
Ancient pagan cults and religions, explicitly including the Cult of Inanna, have an important role in magic and belong intrinsically to the Magi world, distinct from official Church doctrine. The concise World record lives at `magiarchy.html#cult-of-inanna`, with links from World and Church. Keep other cults unnamed until the author identifies them. Fionn's Magi lineage is associated with the Cult of Inanna; Lynleit is indirectly associated through her family, not a direct participant. Mikhail knows this and alludes to it in Doom v5. Keep the full connection in writer records while Chapters, Moment facts, and profiles preserve its implied presentation. The mock honorific is not a cult rank or authentic liturgy, and no sexual obligation, cult-derived blue-flame ability, or compulsory practice follows from it. Other rites, members, powers, locations, and historical continuity remain unresolved. Doctrinal difference alone does not establish exemption from Church jurisdiction, criminal status, or hostility. Do not import real-world religious history as fictional canon without author direction.

## Selected Chapter canon

Doom Has an Address uses v5 as its default and shared canon, integrating the author's 6 September 2026 family allusion and mock blessing before Mikhail's blunt advice. It retains v4's practical teaching, personal examples, banter, and student-friend dialogue. Natalia introduces the ego hypothesis and quotes Jung; no magic-aware physicians appear. The incomplete attempt and curse outcome remain unchanged. Their first completed sexual encounter occurs later in Arc 1. Versions 1 through 4 remain non-canonical alternates. Version-specific behavior notes stay scoped to the appropriate version. Mikhail's insult belongs to his characterization, not to the narrator's assessment of Lynleit's worth or competence.
