...
Ancient pagan cults and religions, explicitly including the Cult of Inanna, have an important role in magic and belong intrinsically to the Magi world, distinct from official Church doctrine. The concise World record lives at `magiarchy.html#cult-of-inanna`, with links from World and Church. Keep other cults unnamed until the author identifies them. No rites, members, powers, locations, historical continuity, or plot involvement are established yet. Doctrinal difference alone does not establish exemption from Church jurisdiction, criminal status, or hostility. Do not import real-world religious history as fictional canon without author direction; keep unresolved integration in the Questions ledger.
