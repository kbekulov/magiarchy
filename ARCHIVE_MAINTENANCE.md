...
| Dread and action | `docs/dread-and-action-direction.md` | Sourced experiential direction for scenes, Holumn encounters, locations, and reader experience; entry points in AGENTS, Thematic Direction, Prose Style, and Scene Guidance; no automatic canon changes |
