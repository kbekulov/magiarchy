...
Doom Has an Address uses v6 as its default and shared canon, adapting the author's 6 September 2026 Russian exchange into English. Mikhail names Inanna, uses family history to provoke Lynleit, and distinguishes a possible treatment from a guarantee. It retains v4's practical teaching, personal examples, banter, and student-friend dialogue. Natalia introduces the ego hypothesis and quotes Jung; no magic-aware physicians appear. The incomplete attempt and curse outcome remain unchanged. Their first completed sexual encounter occurs later in Arc 1. Versions 1 through 5 remain non-canonical alternates. Version-specific behavior notes stay scoped to the appropriate version. Mikhail's insult belongs to his characterization, not to the narrator's assessment of Lynleit's worth or competence.
